...
const BooksTable = () => {
    ...
    const editBook = (bookId) => {
        ...
        navigate("/editBook", { state: { selectedBook } })
    }
                        ...
                        return (
                            <tr key={book.bookId} class="bg-gray-300 border border-grey-500 md:border-none block md:table-row">
                                ...
                                <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell">
                                    ...
                                    <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-2 border border-blue-500 rounded mr-2" onClick={(e) => editBook(book.bookId)}>Edit</button>
                                    <button class="bg-red-500 hover:bg-red-700 text-white font-bold py-1 px-2 border border-red-500 rounded" onClick={(e) => deleteBook(book.bookId)}>Delete</button>
                                </td>
                            </tr>
                        )
                    })}
